...
window.PENTELICO = (function () {
  ...
  var PRODOTTI = [
    ...
    { id: 'acanto', finitura: 'statuario',      tipo: 'borsa',    nome: 'Acanto',      prezzo: 189, repertorio: 'classico',
    ...
    { id: 'meandro', finitura: 'bardiglio',     tipo: 'borsa',    nome: 'Meandro',     prezzo: 179, repertorio: 'classico',
    ...
    { id: 'palmetta', finitura: 'statuario',    tipo: 'borsa',    nome: 'Palmetta',    prezzo: 199, repertorio: 'classico',
    ...
    { id: 'menade', finitura: 'bardiglio',      tipo: 'borsa',    nome: 'Menade',      prezzo: 229, repertorio: 'classico',
    ...
    { id: 'mascherone', finitura: 'antico',  tipo: 'borsa',    nome: 'Mascherone',  prezzo: 229, repertorio: 'siciliano',
    ...
    { id: 'zisa', finitura: 'terracotta',        tipo: 'borsa',    nome: 'Zisa',        prezzo: 209, repertorio: 'siciliano',
    ...
    { id: 'trinacria', finitura: 'terracotta',   tipo: 'borsa',    nome: 'Trinacria',   prezzo: 199, repertorio: 'siciliano',
    ...
    /* ---- gioielli ---- */
    { id: 'voluta', finitura: 'antico',      tipo: 'gioiello', nome: 'Voluta',      prezzo: 49,  repertorio: 'classico',
    ...
    { id: 'conchiglia', finitura: 'statuario',  tipo: 'gioiello', nome: 'Conchiglia',  prezzo: 55,  repertorio: 'classico',
    ...
    { id: 'palmetta-g', finitura: 'bardiglio',  tipo: 'gioiello', nome: 'Palmetta',    prezzo: 45,  repertorio: 'classico',
    ...
    { id: 'caltagirone', finitura: 'terracotta', tipo: 'gioiello', nome: 'Caltagirone', prezzo: 59,  repertorio: 'siciliano',
